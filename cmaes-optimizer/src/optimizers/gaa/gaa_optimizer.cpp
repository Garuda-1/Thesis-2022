...
common::cnf_a gaa_optimizer::mutate(
    const common::cnf_a& cnf, const std::function<double(void)>& rnd, double shrink_scale) {
...
void gaa_optimizer::report_generation(
...
common::cnf_a gaa_optimizer::crossover(
    const common::cnf_a& a, const common::cnf_a& b, const std::function<double(void)>& rnd) {
...
ssize_t gaa_optimizer::fit() {
  ...
  ga.mutate =
      std::bind(&gaa_optimizer::mutate, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
  ga.crossover =
      std::bind(&gaa_optimizer::crossover, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
  ga.SO_report_generation = std::bind(
      &gaa_optimizer::report_generation, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
