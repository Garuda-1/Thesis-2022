...
struct cmaes_optimizer : optimizer {
    ...
    cmaes_optimizer(std::string path_to_solver, std::string path_to_storage, const std::string &path_to_dimacs,
                    double base_value = 1, double sigma = 0.2, int32_t lambda = -1, PGconn *pg_conn = nullptr,
